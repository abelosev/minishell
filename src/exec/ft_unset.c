...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2024/06/15 21:20:41 by aauthier          #+#    #+#             */
/*   Updated: 2024/06/16 03:14:21 by abelosev         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	ft_remove_from_env(t_list_env **env, t_list_env *the_rm_env) //немного отличается от проекта1 теперь
{
    t_list_env	*pos;
    t_list_env	*prev;
    ...
    {
        *env = the_rm_env->next;
        return (ft_free_list_one_node(the_rm_env), 0); //можно ли так записать?
    }
    pos = *env;
